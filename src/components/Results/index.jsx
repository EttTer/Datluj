...
const Result = () => {
  ...
  const sortedPlayersData = [...playersData].sort(
    (a, b) => b.wordsWritten - b.mistakes - (a.wordsWritten - a.mistakes)
  );
  const sortedStartersData = [...startersData].sort(
    (a, b) => b.wordsWritten - b.mistakes - (a.wordsWritten - a.mistakes)
  );
  ...
  return (
    <>
      <div className="Stage_page_container">
        ...
        <button className="Start_page_button">
          <Link to="/starter">Procvičování bez limitu</Link>
        </button>
      </div>
      ...
      <div className="subtitles_container">
        ...
        <p className="description">
          {" "}
          Pořadí výsledků se řídí hodnotou skóre - počet napsaný slov - chyby
        </p>
      </div>
          ...
          {sortedPlayersData.map((onePlayer) => {
            ...
            return (
              <div key={id}>
                <p>
                  {" "}
                  Hráč: {playerName} udělal {mistakes} chyb.
                </p>
                <p>Napsal(a) dobře {wordsWritten} slov a získal(a)</p>
                <p className="score">skóre {difference}</p>
                <hr></hr>
              </div>
            );
          })}
